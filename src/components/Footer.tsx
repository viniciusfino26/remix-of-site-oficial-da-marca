    ...
    <footer className="bg-carbon-gradient text-primary-foreground" role="contentinfo">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/quem-somos" onClick={() => Analytics.ctaClick('Quem Somos', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.whoWeAre')}
                </Link>
              </li>
              <li>
                <Link to="/anti-pirataria" onClick={() => Analytics.ctaClick('Autenticidade INSULFILM', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  Autenticidade INSULFILM™
                </Link>
              </li>
              <li>
                <Link to="/anti-pirataria" onClick={() => Analytics.ctaClick('Anti-Pirataria', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.antiPiracy')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/automotivo" onClick={() => Analytics.ctaClick('Automotivo', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.automotive', 'Automotivo')}
                </Link>
              </li>
              <li>
                <Link to="/residencial" onClick={() => Analytics.ctaClick('Residencial', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  Residencial
                </Link>
              </li>
              <li>
                <Link to="/empresarial" onClick={() => Analytics.ctaClick('Comercial', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  Comercial
                </Link>
              </li>
              <li>
                <Link to="/frota" onClick={() => Analytics.ctaClick('Frotas', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  Frotas
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/lojas" onClick={() => Analytics.storeLocatorClick('footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.storeLocator')}
                </Link>
              </li>
              <li>
                <Link to="/legislacao" onClick={() => Analytics.ctaClick('Legislação', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.legislation', 'Legislação')}
                </Link>
              </li>
              <li>
                <Link to="/sac" onClick={() => Analytics.ctaClick('SAC', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.sac')}
                </Link>
              </li>
              <li>
                <Link to="/faq" onClick={() => Analytics.ctaClick('FAQ', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.faq')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/vendas" onClick={() => Analytics.ctaClick('Central de Vendas', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.salesCentral')}
                </Link>
              </li>
              <li>
                <Link to="/parceiro" onClick={() => Analytics.ctaClick('Seja Parceiro', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.becomePartner')}
                </Link>
              </li>
              <li>
                <Link to="/carreiras" onClick={() => Analytics.ctaClick('Trabalhe Conosco', 'footer')} className="text-sm text-primary-foreground/70 hover:text-accent transition-colors duration-200">
                  {t('nav.careers')}
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-primary-foreground/60 font-light">
            © {new Date().getFullYear()} INSULFILM™. {t('footer.rights')}
          </p>
          <div className="flex gap-4">
            <Link to="/privacidade" onClick={() => Analytics.ctaClick('Privacidade', 'footer')} className="text-xs text-primary-foreground/60 hover:text-accent transition-colors duration-200">{t('footer.privacy')}</Link>
            <Link to="/termos" onClick={() => Analytics.ctaClick('Termos', 'footer')} className="text-xs text-primary-foreground/60 hover:text-accent transition-colors duration-200">{t('footer.terms')}</Link>
            <Link to="/anti-pirataria" onClick={() => Analytics.ctaClick('Anti-Pirataria', 'footer')} className="text-xs text-primary-foreground/60 hover:text-accent transition-colors duration-200">Anti-Pirataria</Link>
          </div>
        </div>
      </div>
    </footer>
