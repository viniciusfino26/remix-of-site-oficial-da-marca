...
const specs = [
  ...
  { icon: Layers, label: 'Espessura', value: '7 mil / 175 micras' },
  { icon: Shield, label: 'Norma', value: 'ABNT NBR' },
  { icon: Shield, label: 'Garantia', value: '5 anos' },
];

const ArqSegurancaISSF7000 = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Película de segurança arquitetônica de 7 mil. Proteção reforçada contra estilhaços, vandalismo e tentativas de invasão.",
    "image": "LINK_DA_IMAGEM_AQUI",
    "url": "https://www.insulfilm.com.br/arquitetonico/seguranca/issf7000",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Espessura", "value": "7 mil / 175 micras" },
      { "@type": "PropertyValue", "name": "Aplicação", "value": "Arquitetônico" },
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ ISSF7000 | Película de Segurança Arquitetônica Reforçada</title>
        <meta name="description" content="Película de segurança arquitetônica de 7 mil. Proteção reforçada contra estilhaços, vandalismo e tentativas de invasão." />
        <meta property="og:title" content="INSULFILM™ ISSF7000 | Película de Segurança Arquitetônica Reforçada" />
        <meta property="og:description" content="Película de segurança arquitetônica de 7 mil. Proteção reforçada contra estilhaços, vandalismo e tentativas de invasão." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/arquitetonico/seguranca/issf7000" />
        <link rel="canonical" href="https://www.insulfilm.com.br/arquitetonico/seguranca/issf7000" />
      ...
      <main>
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">
                Proteção reforçada contra estilhaços e invasões em vidros arquitetônicos
              </motion.p>
        ...
        <ParallaxBreak minHeight="25vh" stats={[{ value: '7 mil', label: 'Espessura' }, { value: 'ASTM', label: 'Certificação' }]} />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Proteção Reforçada para Grandes Superfícies</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">
                  A INSULFILM™ ISSF7000 oferece proteção reforçada com 7 mil de espessura, ideal para edificações que exigem maior nível de segurança. Retém fragmentos com eficiência superior e dificulta tentativas de invasão através de fachadas e janelas.
                </motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Espessura reforçada de 7 mil (175 micras)', 'Retenção superior de fragmentos', 'Dificulta tentativas de invasão por fachadas', 'Garantia de 5 anos'].map((text, i) => (
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInRight}>
                <div className="aspect-[4/3] rounded-2xl bg-muted/10 border border-border/20 flex items-center justify-center">
                  <div className="text-center text-primary-foreground/50"><Building2 className="w-16 h-16 mx-auto mb-3 opacity-30" /><p className="text-sm">Imagem do produto</p></div>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              <motion.h2 variants={fadeInUp} className="text-3xl md:text-5xl font-extrabold text-foreground mb-4">Proteja sua edificação</motion.h2>
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Solicite um orçamento para a película de segurança ISSF7000.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM™ ISSF7000.')}`} target="_blank" rel="noopener noreferrer">
...
export default ArqSegurancaISSF7000;
