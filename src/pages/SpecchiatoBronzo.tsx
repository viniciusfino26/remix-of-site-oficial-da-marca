...
import { Sun, Zap, Palette, Layers, CheckCircle, MessageCircle, Home } from 'lucide-react';
...
const specs = [
  ...
  { icon: Palette, label: 'Estética', value: 'Bronze Refletivo Suave' },
...
const SpecchiatoBronzo = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Tecnologia Sputtered Nichrome. Alívio térmico imediato sem efeito espelho intenso interno. Rejeita até 72% de IR com estética suave.",
    "image": "LINK_DA_IMAGEM_AQUI", "url": "https://www.insulfilm.com.br/specchiato-bronzo",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Tecnologia", "value": "Sputtered Nichrome" },
      { "@type": "PropertyValue", "name": "Estética", "value": "Bronze Refletivo Suave" },
      { "@type": "PropertyValue", "name": "Rejeição de Infravermelho (IR)", "value": "Até 72%" }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Specchiato Bronzo | Película Arquitetônica Sputtered Bronze</title>
        <meta name="description" content="Tecnologia Sputtered Nichrome. Alívio térmico imediato sem efeito espelho intenso interno. Rejeita até 72% de IR com estética suave." />
        <meta property="og:title" content="INSULFILM™ Specchiato Bronzo | Película Arquitetônica Sputtered Bronze" />
        <meta property="og:description" content="Tecnologia Sputtered Nichrome. Alívio térmico imediato sem efeito espelho intenso interno. Rejeita até 72% de IR com estética suave." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/specchiato-bronzo" />
        <script type="application/ld+json">{JSON.stringify(schemaMarkup)}</script>
      </Helmet>
      <main>
        <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Arquitetônico', href: '/arquitetonico' }, { label: 'Controle Solar', href: '/arquitetonico/solar' }, { label: 'Specchiato Bronzo' }]} />
        <section ref={heroRef} className="relative min-h-[60vh] flex flex-col items-center justify-center bg-carbon-gradient overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold text-primary-foreground mb-4 leading-[0.95]">INSULFILM™ Specchiato Bronzo</motion.h1>
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">Tecnologia Sputtered Nichrome. Alívio térmico imediato sem efeito espelho intenso interno. Rejeita até 72% de IR.</motion.p>
        ...
        <ParallaxBreak minHeight="35vh" stats={[
          ...
          { value: 'Nichrome', label: 'Sputtered' },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Estética Bronze com Tecnologia Sputtered</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">A Specchiato Bronzo utiliza tecnologia Sputtered Nichrome para oferecer alívio térmico imediato com um acabamento bronze refletivo suave, sem o efeito espelho intenso no lado interno.</motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Tecnologia Sputtered Nichrome avançada', 'Estética bronze refletiva suave', 'Rejeição de até 72% dos raios infravermelhos', 'Sem efeito espelho intenso no lado interno'].map((text, i) => (
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Estética bronze e performance térmica com a Specchiato Bronzo.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM Specchiato Bronzo.')}`} target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" />Solicitar Orçamento</a>
                </Button>
              </motion.div>
            </motion.div>
          </div>
