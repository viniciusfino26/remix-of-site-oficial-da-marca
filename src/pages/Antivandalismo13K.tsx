...
const Antivandalismo13K = () => {
  ...
  return (
    ...
    <main>
        ...
        >
          <div className="relative rounded-2xl overflow-hidden shadow-premium-lg border border-primary-foreground/10">
            <div className="aspect-video relative">
              <iframe
                src="https://www.youtube.com/embed/nGBNE0FG-8Q?rel=0&modestbranding=1&showinfo=0&iv_load_policy=3&disablekb=1&controls=0&autoplay=1&mute=1&loop=1&playsinline=1&playlist=nGBNE0FG-8Q"
      ...
      {/* ═══ 4. O PERIGO VAI ALÉM DO PREJUÍZO (emocional) ═══ */}
      <section className="py-24 bg-background overflow-hidden">
        <div className="container mx-auto px-4">
          <motion.div
            className="text-center mb-14"
      ...
      {/* ═══ 6. PROTEJA QUEM VOCÊ AMA (emocional) ═══ */}
      <section className="py-24 bg-carbon-gradient overflow-hidden relative">
      ...
      {/* ═══ 9. DEPOIMENTO / CENÁRIO REAL (emocional) ═══ */}
      <section className="py-24 bg-background overflow-hidden">
        <div className="container mx-auto px-4">
          <motion.div
