...
const PRODUCT_NAME = 'INSULFILM™ Phantom 8mil';
const CANONICAL = 'https://www.insulfilm.com.br/automotivo/ppf/phantom-8mil';

const schemaMarkup = {
  '@context': 'https://schema.org',
  '@type': 'Product',
  name: PRODUCT_NAME,
  description: 'Película PPF premium de proteção de pintura com 8 mil de espessura (~200 microns), acabamento transparente gloss, composição de 5 camadas e garantia de 5 anos.',
  brand: { '@type': 'Brand', name: 'INSULFILM™' },
  url: CANONICAL,
  category: 'Paint Protection Film',
  offers: { '@type': 'Offer', priceCurrency: 'BRL', availability: 'https://schema.org/InStock' },
  additionalProperty: [
    { '@type': 'PropertyValue', name: 'Espessura', value: '8 mil / ~200 microns' },
...
const WHATSAPP = `https://wa.me/5511976136911?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre o INSULFILM™ Phantom 8mil.')}`;
  ...
  <>
    ...
    <main>
        ...
        <div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/70 font-light max-w-2xl mx-auto italic">
              "Proteção máxima e invisível para quem não aceita menos.<br />Espessura premium para o mais alto nível de proteção."
            </motion.p>
      ...
      <ParallaxBreak minHeight="25vh" stats={[
        { value: '8', label: 'mil de espessura' },
...
export default AutomotivoPhantom8;
