...
const PRODUCT_NAME = 'INSULFILM™ Phantom';
const CANONICAL = 'https://www.insulfilm.com.br/automotivo/ppf/phantom-gloss';

const schemaMarkup = {
  '@context': 'https://schema.org',
  '@type': 'Product',
  name: PRODUCT_NAME,
  description: 'Película PPF de proteção de pintura com 7 mil de espessura (~175 microns), acabamento transparente gloss, composição de 5 camadas e garantia de 5 anos.',
  brand: { '@type': 'Brand', name: 'INSULFILM™' },
  url: CANONICAL,
  category: 'Paint Protection Film',
  offers: { '@type': 'Offer', priceCurrency: 'BRL', availability: 'https://schema.org/InStock' },
  additionalProperty: [
    { '@type': 'PropertyValue', name: 'Espessura', value: '7 mil / ~175 microns' },
...
const compositionLayers = [
  ...
  { title: 'Uretano Termoplástico (TPU)', desc: 'Resistente à rachaduras, impactos leves e perfurações. Formulado para excelente rejeição de calor e raios UV.', icon: Shield },
  ...
  <>
    ...
    <main>
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeInUp} className="flex justify-center mb-4">
              <Badge className="bg-accent/10 text-accent border-accent/20 text-xs uppercase tracking-widest px-4 py-1.5">
                <Paintbrush className="w-3.5 h-3.5 mr-2" />Película de Proteção de Pintura | Paint Protection Film (PPF)
              </Badge>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="mt-8 mb-6">
              <p className="text-sm text-primary-foreground/70 uppercase tracking-wider mb-3">Livre-se da preocupação e prejuízos com:</p>
      ...
      <ParallaxBreak minHeight="25vh" stats={[
        { value: '7', label: 'mil de espessura' },
...
export default AutomotivoPhantomGloss;
