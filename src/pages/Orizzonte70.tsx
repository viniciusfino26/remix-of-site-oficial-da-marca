...
import { Sun, Zap, Eye, Layers, CheckCircle, MessageCircle, Home } from 'lucide-react';
...
const specs = [
  ...
  { icon: Sun, label: 'Rejeição de IR', value: 'Até 93%' },
...
const Orizzonte70 = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Alta performance térmica. Garante 68% de transparência e extrema rejeição de calor com bloqueio de 93% dos raios IR.",
    "image": "LINK_DA_IMAGEM_AQUI", "url": "https://www.insulfilm.com.br/orizzonte70",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Tecnologia", "value": "Cerâmica Premium" },
      { "@type": "PropertyValue", "name": "Transmissão de Luz", "value": "68%" },
      { "@type": "PropertyValue", "name": "Rejeição de Infravermelho (IR)", "value": "Até 93%" }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Orizzonte70 | Película Arquitetônica de Cerâmica Premium</title>
        <meta name="description" content="Alta performance térmica. Garante 68% de transparência e extrema rejeição de calor com bloqueio de 93% dos raios IR." />
        <meta property="og:title" content="INSULFILM™ Orizzonte70 | Película Arquitetônica de Cerâmica Premium" />
        <meta property="og:description" content="Alta performance térmica. Garante 68% de transparência e extrema rejeição de calor com bloqueio de 93% dos raios IR." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/orizzonte70" />
        <script type="application/ld+json">{JSON.stringify(schemaMarkup)}</script>
      </Helmet>
      <main>
        <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Arquitetônico', href: '/arquitetonico' }, { label: 'Controle Solar', href: '/arquitetonico/solar' }, { label: 'Orizzonte 70' }]} />
        <section ref={heroRef} className="relative min-h-[60vh] flex flex-col items-center justify-center bg-carbon-gradient overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold text-primary-foreground mb-4 leading-[0.95]">INSULFILM™ Orizzonte70</motion.h1>
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">Alta performance térmica. Garante 68% de transparência e extrema rejeição de calor com bloqueio de 93% dos raios IR.</motion.p>
        ...
        <ParallaxBreak minHeight="35vh" stats={[
          { value: '68%', label: 'Transmissão de Luz' },
          { value: '93%', label: 'Rejeição IR' },
          { value: 'Premium', label: 'Cerâmica' },
        ]} />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Performance Térmica Extrema</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">A INSULFILM™ Orizzonte70 é a escolha ideal para projetos que exigem máxima rejeição de calor sem comprometer a transparência. Com tecnologia cerâmica premium, bloqueia 93% dos raios infravermelhos.</motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Tecnologia cerâmica premium de última geração', '68% de transmissão de luz visível', 'Rejeição extrema de 93% dos raios infravermelhos', 'Performance térmica superior para grandes envidraçamentos'].map((text, i) => (
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Descubra como a Orizzonte70 pode transformar o conforto térmico do seu ambiente.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM Orizzonte70.')}`} target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" />Solicitar Orçamento</a>
                </Button>
              </motion.div>
            </motion.div>
          </div>
