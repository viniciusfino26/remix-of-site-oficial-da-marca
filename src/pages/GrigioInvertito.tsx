  ...
  return (
    <>
      ...
      <main>
        ...
        <TechSpecsHighlight
          title="Ficha Técnica Grigio Invertito"
          subtitle="Acabamento grafite com alta rejeição térmica e proteção UV total."
          highlights={[
            { value: '75%', label: 'Rejeição IR', sublabel: 'Calor bloqueado' },
            { value: '70%', label: 'Energia Solar', sublabel: 'Rejeitada' },
        ...
        <PDPFaqSection slug="grigio-invertito" />
      </main>
    </>
  );
};
