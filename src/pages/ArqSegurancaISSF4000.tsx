...
const ArqSegurancaISSF4000 = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Película de segurança arquitetônica de 4 mil. Proteção contra estilhaços e vandalismo em vidros de edificações.",
    "image": "LINK_DA_IMAGEM_AQUI",
    "url": "https://www.insulfilm.com.br/arquitetonico/seguranca/issf4000",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Espessura", "value": "4 mil / 100 micras" },
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ ISSF4000 | Película de Segurança Arquitetônica</title>
        <meta name="description" content="Película de segurança arquitetônica de 4 mil. Proteção contra estilhaços e vandalismo em vidros de edificações." />
        <meta property="og:title" content="INSULFILM™ ISSF4000 | Película de Segurança Arquitetônica" />
        <meta property="og:description" content="Película de segurança arquitetônica de 4 mil. Proteção contra estilhaços e vandalismo em vidros de edificações." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/arquitetonico/seguranca/issf4000" />
        <link rel="canonical" href="https://www.insulfilm.com.br/arquitetonico/seguranca/issf4000" />
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">
                Proteção contra estilhaços e vandalismo para vidros arquitetônicos
              </motion.p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Segurança para Edificações</motion.h2>
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Solicite um orçamento para a película de segurança ISSF4000.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM™ ISSF4000.')}`} target="_blank" rel="noopener noreferrer">
...
export default ArqSegurancaISSF4000;
