  ...
  return (
    <>
      ...
      <main>
        ...
        <TechSpecsHighlight
          title="Ficha Técnica Polariz Ultra"
          subtitle="Híbrida metal-cerâmica de 5ª geração. Visual polarizado e performance premium."
          highlights={[
            { value: '75%', label: 'Rejeição IR', sublabel: 'Calor bloqueado' },
            { value: '99%', label: 'Bloqueio UV', sublabel: 'Proteção total' },
            { value: '5ª', label: 'Geração', sublabel: 'Híbrida Metal-Cerâmica' },
        ...
        <PDPFaqSection slug="polariz-ultra" />
      </main>
    </>
  );
};
