...
import { Sun, Palette, Layers, Zap, CheckCircle, MessageCircle, Home } from 'lucide-react';
...
const specs = [
  ...
  { icon: Zap, label: 'Performance', value: 'Máximo Térmico' },
  { icon: Layers, label: 'Categoria', value: 'Arquitetônica' },
];

const MetallicoArgento = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Máximo desempenho térmico com estética prateada espelhada. Ideal para fachadas, bloqueando até 86% de IR.",
    "image": "LINK_DA_IMAGEM_AQUI", "url": "https://www.insulfilm.com.br/metallico-argento",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Estética", "value": "Prateada Espelhada" },
      { "@type": "PropertyValue", "name": "Rejeição de Infravermelho (IR)", "value": "Até 86%" }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Metallico Argento | Película Arquitetônica Prateada Espelhada</title>
        <meta name="description" content="Máximo desempenho térmico com estética prateada espelhada. Ideal para fachadas, bloqueando até 86% de IR." />
        <meta property="og:title" content="INSULFILM™ Metallico Argento | Película Arquitetônica Prateada Espelhada" />
        <meta property="og:description" content="Máximo desempenho térmico com estética prateada espelhada. Ideal para fachadas, bloqueando até 86% de IR." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/metallico-argento" />
      ...
      <main>
        <section ref={heroRef} className="relative min-h-[60vh] flex flex-col items-center justify-center bg-carbon-gradient overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold text-primary-foreground mb-4 leading-[0.95]">INSULFILM™ Metallico Argento</motion.h1>
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">Máximo desempenho térmico com estética prateada espelhada. Ideal para fachadas, bloqueando até 86% de IR.</motion.p>
        ...
        <ParallaxBreak minHeight="35vh" stats={[
          ...
          { value: 'Espelhada', label: 'Estética' },
          { value: 'Máximo', label: 'Desempenho' },
        ]} />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Performance Térmica Máxima</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">A Metallico Argento oferece o máximo desempenho térmico do portfólio com sua estética prateada espelhada, ideal para fachadas comerciais e residenciais que exigem máxima rejeição de calor.</motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Estética prateada espelhada premium', 'Rejeição de até 86% dos raios infravermelhos', 'Ideal para fachadas e grandes envidraçamentos', 'Máximo desempenho térmico do portfólio'].map((text, i) => (
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Transforme sua fachada com a Metallico Argento.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM Metallico Argento.')}`} target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" />Solicitar Orçamento</a>
                </Button>
              </motion.div>
            </motion.div>
          </div>
