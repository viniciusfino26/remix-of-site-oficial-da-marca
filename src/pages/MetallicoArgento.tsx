  ...
  return (
    <>
      ...
      <main>
        ...
        <TechSpecsHighlight
          title="Ficha Técnica Metallico Argento"
          subtitle="Tecnologia metalizada de alto poder refletivo. Os índices comprovam."
          highlights={[
            { value: '86%', label: 'Rejeição IR', sublabel: 'Calor bloqueado' },
            { value: '80%', label: 'Energia Solar', sublabel: 'Rejeitada' },
