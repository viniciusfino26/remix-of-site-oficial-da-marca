...
const AutomotivoDark = () => {
  ...
  const schemaMarkup = {
    ...
    "url": "https://www.insulfilm.com.br/automotivo/solar/dark",
    "additionalProperty": [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://www.insulfilm.com.br/automotivo/solar/dark" />
        <link rel="canonical" href="https://www.insulfilm.com.br/automotivo/solar/dark" />
        <script type="application/ld+json">{JSON.stringify(schemaMarkup)}</script>
      </Helmet>
      <main>
        <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Automotivo', href: '/automotivo' }, { label: 'Películas Solares', href: '/automotivo/solar' }, { label: 'Dark' }]} />
        ...
        <section className="py-24 bg-carbon-gradient overflow-hidden relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger} className="max-w-3xl mx-auto">
              <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">O Clássico que Nunca Sai de Moda</motion.h2>
