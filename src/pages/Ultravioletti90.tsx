  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 max-w-4xl">
            <ProductImagePlaceholder
              alt="Película arquitetônica incolor INSULFILM™ Ultravioletti90 aplicada em vitrine"
              icon={Building2}
              variant="light"
            />
          </div>
        ...
        <TechSpecsHighlight
          title="Ficha Técnica Ultravioletti90"
          subtitle="Proteção UV máxima sem alterar a aparência do vidro."
          highlights={[
            { value: '>99%', label: 'Bloqueio UV', sublabel: 'Proteção total' },
            { value: '88%', label: 'Luz Visível', sublabel: 'Transmissão preservada' },
            { value: 'Incolor', label: 'Aparência', sublabel: 'Sem alteração estética' },
            { value: '5 anos', label: 'Garantia', sublabel: 'INSULFILM™' },
          ]}
          techTable={techTable}
        ...
        <PDPFaqSection slug="ultravioletti90" />
      </main>
    </>
  );
};
