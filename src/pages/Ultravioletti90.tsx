...
import { Sun, Eye, Shield, Layers, CheckCircle, MessageCircle, Home } from 'lucide-react';
...
const Ultravioletti90 = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Defesa discreta com clareza absoluta. Película incolor com 88% de transmissão de luz e bloqueio de >99% dos raios UV.",
    "image": "LINK_DA_IMAGEM_AQUI", "url": "https://www.insulfilm.com.br/ultravioletti90",
    "additionalProperty": [
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Ultravioletti90 | Película Arquitetônica Proteção UV</title>
        <meta name="description" content="Defesa discreta com clareza absoluta. Película incolor com 88% de transmissão de luz e bloqueio de >99% dos raios UV." />
        <meta property="og:title" content="INSULFILM™ Ultravioletti90 | Película Arquitetônica Proteção UV" />
        <meta property="og:description" content="Defesa discreta com clareza absoluta. Película incolor com 88% de transmissão de luz e bloqueio de >99% dos raios UV." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/ultravioletti90" />
        <script type="application/ld+json">{JSON.stringify(schemaMarkup)}</script>
      </Helmet>
      <main>
        <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Arquitetônico', href: '/arquitetonico' }, { label: 'Controle Solar', href: '/arquitetonico/solar' }, { label: 'Ultravioletti 90' }]} />
        <section ref={heroRef} className="relative min-h-[60vh] flex flex-col items-center justify-center bg-carbon-gradient overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold text-primary-foreground mb-4 leading-[0.95]">INSULFILM™ Ultravioletti90</motion.h1>
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">Defesa discreta com clareza absoluta. Película incolor com 88% de transmissão de luz e bloqueio de &gt;99% dos raios UV.</motion.p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Proteção UV Invisível</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">A Ultravioletti90 é a solução ideal para proteger móveis, pisos e obras de arte contra o desbotamento causado por raios UV, sem alterar a aparência do vidro.</motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Película praticamente incolor e imperceptível', '88% de transmissão de luz visível', 'Bloqueio de mais de 99% dos raios ultravioleta', 'Protege móveis, pisos e obras de arte contra desbotamento'].map((text, i) => (
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Proteja seus ambientes dos raios UV com a Ultravioletti90.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM Ultravioletti90.')}`} target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" />Solicitar Orçamento</a>
                </Button>
              </motion.div>
            </motion.div>
          </div>
