...
const AutomotivoMatrix = () => {
  ...
  const schemaMarkup = {
    ...
    "url": "https://www.insulfilm.com.br/automotivo/solar/matrix",
    "additionalProperty": [
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Matrix | Película Automotiva Nano Cerâmica</title>
        <meta name="description" content="Película premium de nano cerâmica verdadeira. Rejeição de até 75% dos raios infravermelhos e 10 anos de garantia." />
        <meta property="og:title" content="INSULFILM™ Matrix | Película Automotiva Nano Cerâmica" />
        <meta property="og:description" content="Película premium de nano cerâmica verdadeira. Rejeição de até 75% dos raios infravermelhos e 10 anos de garantia." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/automotivo/solar/matrix" />
        <link rel="canonical" href="https://www.insulfilm.com.br/automotivo/solar/matrix" />
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">
                {t('automotivePage.ltMatrix.desc')}
              </motion.p>
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              <motion.h2 variants={fadeInUp} className="text-3xl md:text-5xl font-extrabold text-foreground mb-4">
                Proteja seu veículo com a Matrix
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">
                Solicite um orçamento e descubra a película nano cerâmica mais avançada do mercado.
              </motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM™ Matrix.')}`} target="_blank" rel="noopener noreferrer">
