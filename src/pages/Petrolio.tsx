...
const specs = [
  ...
  { icon: Palette, label: 'Estética', value: 'Preto Sofisticado' },
...
const Petrolio = () => {
  ...
  const schemaMarkup = {
    ...
    "description": "Tecnologia híbrida com visual preto sofisticado (charcoal). Privacidade, conforto térmico e rejeição de até 42% dos raios IR.",
    "image": "LINK_DA_IMAGEM_AQUI", "url": "https://www.insulfilm.com.br/petrolio",
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "Tecnologia", "value": "Híbrida Fumê (Charcoal)" },
      { "@type": "PropertyValue", "name": "Rejeição de Infravermelho (IR)", "value": "Até 42%" }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>INSULFILM™ Petrolio | Película Arquitetônica Fumê de Alta Durabilidade</title>
        <meta name="description" content="Tecnologia híbrida com visual preto sofisticado (charcoal). Privacidade, conforto térmico e rejeição de até 42% dos raios IR." />
        <meta property="og:title" content="INSULFILM™ Petrolio | Película Arquitetônica Fumê de Alta Durabilidade" />
        <meta property="og:description" content="Tecnologia híbrida com visual preto sofisticado (charcoal). Privacidade, conforto térmico e rejeição de até 42% dos raios IR." />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="LINK_DA_IMAGEM_AQUI" />
        <meta property="og:url" content="https://www.insulfilm.com.br/petrolio" />
        <script type="application/ld+json">{JSON.stringify(schemaMarkup)}</script>
      </Helmet>
      <main>
        <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Arquitetônico', href: '/arquitetonico' }, { label: 'Controle Solar', href: '/arquitetonico/solar' }, { label: 'Petrólio' }]} />
        <section ref={heroRef} className="relative min-h-[60vh] flex flex-col items-center justify-center bg-carbon-gradient overflow-hidden">
          ...
          <motion.div className="container mx-auto px-4 pt-32 pb-20 relative z-10 text-center" style={{ y: heroTextY, opacity: heroOpacity }}>
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold text-primary-foreground mb-4 leading-[0.95]">INSULFILM™ Petrolio</motion.h1>
              <motion.p variants={fadeInUp} className="text-lg md:text-xl text-primary-foreground/60 font-light max-w-2xl mx-auto">Tecnologia híbrida com visual preto sofisticado. Privacidade, conforto térmico e rejeição de até 42% dos raios IR.</motion.p>
        ...
        <ParallaxBreak minHeight="35vh" stats={[
          { value: '42%', label: 'Rejeição IR' },
          { value: 'Híbrida', label: 'Tecnologia' },
          { value: 'Charcoal', label: 'Acabamento' },
        ]} />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
                <motion.h2 variants={fadeInLeft} className="text-3xl md:text-4xl font-extrabold text-primary-foreground mb-6">Privacidade com Sofisticação</motion.h2>
                <motion.p variants={fadeInLeft} className="text-primary-foreground/60 font-light leading-relaxed mb-8">A Petrolio combina tecnologia híbrida com visual charcoal sofisticado, oferecendo privacidade e conforto térmico com alta durabilidade e estabilidade de cor.</motion.p>
                <motion.ul className="space-y-4" variants={stagger}>
                  {['Tecnologia híbrida de alta durabilidade', 'Visual preto sofisticado (charcoal)', 'Privacidade e controle de luz', 'Rejeição de até 42% dos raios infravermelhos'].map((text, i) => (
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div className="text-center max-w-2xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
              ...
              <motion.p variants={fadeInUp} className="text-muted-foreground text-lg font-light mb-8">Privacidade e sofisticação com a Petrolio para o seu projeto.</motion.p>
              <motion.div variants={scaleIn}>
                <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-premium-lg hover:shadow-premium transition-all">
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a película INSULFILM Petrolio.')}`} target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" />Solicitar Orçamento</a>
                </Button>
              </motion.div>
            </motion.div>
          </div>
